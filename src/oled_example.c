...
#define SCL3    P1_0                // Serial Clock Input
#define SDA3    P1_1                // Serial Data Input
...
{
    serial_init(9600);
    unsigned char exist_flag = i2c_addressing(0x78 >> 1);
    if (exist_flag) {
        printf_tiny("oled exist!\n");
    } else {
        printf_tiny("oled not exist!\n");
    }
